...
// if (Dolphins > Koalas) {
//     console.log("Dolphins winner of the competition");
// }else if(Koalas > Dolphins){
//     console.log("Koalas winner of the competition");
// }else{
...
// if(Dround1 >= 100|| Dround2 >= 100|| Dround3 >= 100 && Dolphins > Koalas){
//     console.log("Dolphins winner of the competition"); 
// }else if(Kround1 >= 100 || Kround2 >= 100 || Kround3 >= 100 && Koalas > Dolphins){
//     console.log("Koalas winner of the competition");    
// }else{
//     console.log("The competition is a Draw");
// }
